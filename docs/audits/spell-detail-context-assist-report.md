...
- `assist:spell-details` now writes `data/spells/review/spell-detail-context.json` with page-context clues.
...
- Review-context artifact path: `data/spells/review/spell-detail-context.json`.
